...
//        titleLabel.text = [NSString stringWithFormat:@"%i %@ %i", _currentIndex+1, NSLocalizedString(@"of", @"") , [_photoSource numberOfPhotosForPhotoGallery:self]];
...
- (void)scrollingHasEnded {
	...
	int newIndex = floor( _scroller.contentOffset.x / _scroller.frame.size.width );
	...
	//NSLog(@"_currentIndex:%d,%d",_currentIndex,newIndex);
